    ...
    <div className="mt-10 max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-lg">
      ...
      <div className="mb-8 p-4 bg-gray-50 rounded-lg shadow-inner">
        ...
        <button
          ...
          className="bg-purple-600 text-white py-2 px-5 rounded-md hover:bg-purple-800 "
        >
          Submit Review
        </button>
      </div>
      ...
      <div className="space-y-4">
        ...
        {reviews.map((r) => (
          <div
            key={r._id || r.date}
            className="border border-gray-200  borer p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow"
          >

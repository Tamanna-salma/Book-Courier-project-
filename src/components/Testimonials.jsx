                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {reviews.map((item, index) => (
                        <motion.div
                            ...
                            className="bg-white dark:bg-slate-900/50 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 hover:shadow-2xl hover:border-cyan-500/30 transition-all duration-300 flex flex-col h-full"
                        >
                            {/* Star Rating */}
                            ...
                            <p className="text-gray-600 dark:text-gray-400 italic mb-6 flex-grow leading-relaxed">
                                "{item.review}"
                            </p>
                            ...
                            <div className="flex items-center gap-4 mt-auto">
                                <img
                                    src={item.image}
                                    alt={item.name}
                                    className="w-12 h-12 rounded-full border-2 border-cyan-600 p-0.5"
                                />
                                <div>
